import{d as W,L as H,c as I,o as g,w as o,a,b as t,u as m,g as U,e as b,t as n,f as y,h as S,F as X,r as E,x as V,W as M}from"./app-D8GMqoQL.js";import{_ as Y}from"./index-CKTUUg4B.js";import{_ as f}from"./Select.vue_vue_type_script_setup_true_lang-NzKcQ-CX.js";import"./LocationInput.vue_vue_type_style_index_0_scoped_0fe2f881_lang-Ay1pUOAN.js";import{R as z,C as q,_ as G}from"./AppLayout.vue_vue_type_script_setup_true_lang-B7FY6UE4.js";import{_ as p,a as x}from"./CardContent.vue_vue_type_script_setup_true_lang-zCpbmRui.js";import{_ as P,a as D}from"./CardTitle.vue_vue_type_script_setup_true_lang-COI8iZOX.js";import{P as J}from"./printer-Bhvn-fAG.js";import{D as K,C as Q}from"./dollar-sign-CyeFLtLp.js";import{C as Z}from"./circle-alert-DJTF13WT.js";import"./DropdownMenuTrigger.vue_vue_type_script_setup_true_lang-DtVqRXXk.js";import"./createLucideIcon-sEmkw9Pt.js";import"./RovingFocusGroup-B0Y8hFFN.js";import"./VisuallyHidden-DKr5urU_.js";import"./AppLogoIcon.vue_vue_type_script_setup_true_lang-BH_Bl99z.js";import"./chevron-right-CmK6lVL2.js";const tt={class:"flex items-center justify-between mb-6"},et={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8"},at={class:"flex items-center justify-between"},st={class:"text-2xl font-bold text-gray-900 dark:text-gray-100"},rt={class:"p-3 bg-green-100 dark:bg-green-900/20 rounded-full"},ot={class:"flex items-center justify-between"},lt={class:"text-2xl font-bold text-gray-900 dark:text-gray-100"},dt={class:"p-3 bg-blue-100 dark:bg-blue-900/20 rounded-full"},nt={class:"flex items-center justify-between"},it={class:"text-2xl font-bold text-gray-900 dark:text-gray-100"},mt={class:"p-3 bg-green-100 dark:bg-green-900/20 rounded-full"},ut={class:"flex items-center justify-between"},pt={class:"text-2xl font-bold text-gray-900 dark:text-gray-100"},xt={class:"p-3 bg-red-100 dark:bg-red-900/20 rounded-full"},gt={class:"flex items-center justify-between"},ct={class:"text-2xl font-bold text-gray-900 dark:text-gray-100"},yt={class:"p-3 bg-purple-100 dark:bg-purple-900/20 rounded-full"},ft={class:"grid grid-cols-1 md:grid-cols-4 gap-4"},bt={class:"overflow-x-auto"},_t={class:"w-full"},vt={class:"py-3 px-4 text-sm text-gray-900 dark:text-gray-100"},ht={class:"py-3 px-4 text-sm text-gray-900 dark:text-gray-100"},kt={class:"py-3 px-4"},wt={class:"text-sm font-medium text-gray-900 dark:text-gray-100"},Tt={key:0,class:"text-sm text-gray-500 dark:text-gray-400"},Ct={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},$t={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},St={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},Vt={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},zt={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},Pt={class:"py-3 px-4 text-right text-sm text-gray-900 dark:text-gray-100"},Dt={class:"py-3 px-4"},At={key:0,class:"text-center py-12"},Rt={class:"mx-auto h-12 w-12 text-gray-400"},Jt=W({__name:"Transactions",props:{transactions:{},customers:{},summary:{},filters:{}},setup(A){const u=A,d=H({...u.filters}),R=[{title:"Sales",href:"/sales/transactions"},{title:"Transactions",href:"/sales/transactions"}],_=[{value:"week",label:"Last Week"},{value:"month",label:"Last Month"},{value:"year",label:"Last Year"}],v=[{value:"created_at",label:"Date"},{value:"total_amount",label:"Amount"},{value:"payment_status",label:"Status"}],h=[{value:"desc",label:"Descending"},{value:"asc",label:"Ascending"}],c=()=>{M.get("/sales/transactions",d,{preserveState:!0,preserveScroll:!0})},i=l=>new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP",minimumFractionDigits:2}).format(l),k=l=>new Date(l).toLocaleDateString("en-PH",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),B=l=>{switch(l){case"Completed":return"bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400";case"Canceled":return"bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400";case"Refunded":return"bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400";default:return"bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400"}},O=()=>{var w,T,C,$;const l=window.open("","_blank");if(!l)return;const e=new Date().toLocaleDateString("en-PH",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit"}),s=((w=_.find(r=>r.value===d.period))==null?void 0:w.label)||d.period,j=d.customer==="all"?"All Customers":((T=u.customers.find(r=>r.value===d.customer))==null?void 0:T.label)||d.customer,F=((C=v.find(r=>r.value===d.sort_by))==null?void 0:C.label)||d.sort_by,L=(($=h.find(r=>r.value===d.sort_order))==null?void 0:$.label)||d.sort_order,N=`
    <!DOCTYPE html>
    <html>
    <head>
